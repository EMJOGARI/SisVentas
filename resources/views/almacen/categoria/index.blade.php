					...
					@foreach ($categorias as $cat)
						<tr>
							...
							<td>
								...
								<a href="{{ URL::action('CategoriaController@destroy',$cat->idcategoria) }}" data-target="#modal-delete-{{ $cat->idcategoria }}" data-toggle="modal"> <button class="btn btn-danger">Eliminar</button></a>
							</td>
						</tr>
