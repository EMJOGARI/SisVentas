{!! Form::open(array('url'=>'reporte/ingreso/analisis-vencimiento', 'method'=>'GET', 'autocomplete'=>'off', 'role'=>'search' )) !!}
	...
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 pull-right">
		<div class="form-group">
			<div class="input-group">
				<input type="text" class="form-control" name="searchText" placeholder="Buscar Nº Factura..." value="{{ $fact }}">
				<span class="input-group-btn">
