							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu">
										<li><a href="#{{-- url('cobranza/cuenta-por-cobrar/create') --}}{{-- URL::action(' CuentasporcobrarController@create',$ven->idventa) --}}"><i class="fa fa-clipboard"></i> Nota de Debito</a></li>
